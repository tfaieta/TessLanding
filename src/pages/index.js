        ...
        <div id="main">
          ...
          <section id="first" className="main special">
            ...
            <ul className="features">
              <li>
                <span className="icon major style3 fa-magic"></span>
                <h3>Use it Everywhere</h3>
                <p>Tess works on iPhone, Android, and and the web, 
                so you can listen to all your favorite podcasts wherever you are.</p>
              </li>
              <li>
                <span className="icon major style1 fa-bookmark-o"></span>
                <h3>Highlight and Share</h3>
                <p>Save highlights of podcasts to your library for later listening or share a highlight with
                others!
                </p>                
              </li>
              <li>
                ...
                <h3>Open Source</h3>
                <p>Through open source, anyone can propose new features and make Tess better.</p>
              </li>
            </ul>
          </section>
          ...
          <section id="second" className="main special">
            <header className="major">
              ...
              <p>Tess uses React Native for it's iOS/Android app,<br/>
            ...
            <ul className="statistics">
              ...
              <li className="style2">
                <span className="icon fa-rss"></span>
            ...
            <p>
            Tess is looking for a lot of help from podcast lovers looking to make a better free podcast app.
            If you would like to talk more about Tess or become a maintainer you can join our Discord server below.
            </p>
            <footer className="major">
              <ul className="actions">
                <a href="https://discord.gg/JuucUTc" className="button">Join on Discord!</a>
              </ul>
            </footer>
          </section>
